...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/jquery.japanese-date-converter.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/jquery.japanese-date-converter.js":
/*!***********************************************!*\
  !*** ./src/jquery.japanese-date-converter.js ***!
  \***********************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var _japanese_date_converter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./japanese-date-converter */ \"./src/japanese-date-converter.ts\");\n\n\n(function ($) {\n  var japanese_date_converter = function japanese_date_converter(options) {\n    var defaultSettings = {\n      format: \"geemmdd\"\n    };\n    var settings = Object.assign({}, defaultSettings, options);\n    this.on({\n      \"change\": function change(e) {\n        var inputValue = ($(this).val() || \"\").toString();\n        var converter = new _japanese_date_converter__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n          inputValue: inputValue,\n          settings: settings\n        });\n        $(this).val(converter.execute());\n      }\n    });\n    return this;\n  };\n\n  $.fn.japanese_date_converter = japanese_date_converter;\n})(jQuery);\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ \"jquery\")))\n\n//# sourceURL=webpack:///./src/jquery.japanese-date-converter.js?");
